...
Original file is located at
    https://colab.research.google.com/drive/1vAOqAeXsjO5vLvBNWWPPh9ZA-yaEQ346
...
gray_like = build_image_like_tensor(255, 255, 3, (128,128,128))
...
def convolution_forward_torch(image, kernel):
  ...
  # old chanel  nb features ma qu'on veut en sortie 
  #ici 1 seul chanel
  # out 
...
if __name__ == "__main__" :
  ...
  fmnist_train = DataLoader(fmnist_train, batch_size=32, num_workers=4, pin_memory=True)#Créer des batchs de 32
  # Dataloader lus our le training -> Aller  vite, ca nous les mets deja en batch
  # on doit itérer maintenant for image target int (sortie dataloader )
  # itérer sur l'objet
